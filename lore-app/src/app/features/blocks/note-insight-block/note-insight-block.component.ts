...
@Component({
  ...
  template: `
    <div class="blk-callout note-b">
      <div class="blk-ico">📝</div>
      <div class="blk-body">
        <div class="blk-lbl">Note / Insight</div>
        <div
          class="blk-txt"
          [contentEditable]="!readOnly()"
          [attr.data-placeholder]="'Write a note or insight…'"
          (input)="onInput($event)"
  ...
  styles: [`
    ...
    .note-b { background: var(--lore-primitive-purple-50); border-color: var(--lore-primitive-purple-400); }
    .blk-ico { font-size: 14px; flex-shrink: 0; margin-top: 1px; }
    .blk-body { flex: 1; }
    .blk-lbl {
      font-size: 9.5px; font-weight: 600; letter-spacing: 0.1em;
      text-transform: uppercase; font-family: 'JetBrains Mono', monospace;
      margin-bottom: 4px; color: var(--lore-primitive-purple-600);
    }
    .blk-txt {
...
export class NoteInsightBlockComponent {
