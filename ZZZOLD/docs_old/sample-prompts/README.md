...
## Markdown Prompts
Responses render via the markdown parser — headings, tables, code blocks, blockquotes all styled.

- `01-tech-research-summary.md`
- `02-weekly-stock-analysis.md`
- `03-personal-journal-entry.md`

## HTML Prompts
Responses render with full original styling — fonts, colors, layout preserved inside the note card.

- `04-styled-newsletter.md`
- `05-financial-report-card.md`
