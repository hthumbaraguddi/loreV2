...
@Component({
  ...
  template: `
    <div class="blk-callout warn">
      <div class="blk-ico">⚠️</div>
      <div class="blk-body">
        <div class="blk-lbl">Warning</div>
        <div
          class="blk-txt"
          [contentEditable]="!readOnly()"
          [attr.data-placeholder]="'Describe the risk or caveat…'"
          (input)="onInput($event)"
  ...
  styles: [`
    ...
    .warn { background: var(--lore-primitive-red-50); border-color: var(--lore-primitive-red-600); }
    .blk-ico { font-size: 14px; flex-shrink: 0; margin-top: 1px; }
    .blk-body { flex: 1; }
    .blk-lbl {
      font-size: 9.5px; font-weight: 600; letter-spacing: 0.1em;
      text-transform: uppercase; font-family: 'JetBrains Mono', monospace;
      margin-bottom: 4px; color: var(--lore-primitive-red-700);
    }
    .blk-txt {
