...
@Component({
  ...
  template: `
    <div class="blk-callout quote">
      <div class="blk-ico">❝</div>
      <div class="blk-body">
        <div class="blk-lbl">Quote</div>
        <div
          class="blk-txt"
          [contentEditable]="!readOnly()"
          [attr.data-placeholder]="'Enter a quote…'"
          (input)="onInput($event)"
  ...
  styles: [`
    .blk-callout {
      display: flex; gap: 10px; border-left: 3px solid;
      border-radius: 0 var(--lore-radius-md) var(--lore-radius-md) 0;
      padding: 11px 13px;
    }
    .quote { background: var(--lore-primitive-blue-50); border-color: var(--lore-primitive-blue-600); }
    .blk-ico { font-size: 16px; flex-shrink: 0; margin-top: 1px; color: var(--lore-primitive-blue-400); }
    .blk-body { flex: 1; }
    .blk-lbl {
      font-size: 9.5px; font-weight: 600; letter-spacing: 0.1em;
      text-transform: uppercase; font-family: 'JetBrains Mono', monospace;
      margin-bottom: 4px; color: var(--lore-primitive-blue-700);
    }
    .blk-txt {
